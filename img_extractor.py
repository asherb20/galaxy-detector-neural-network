...
class ImageExtractor:
   ...
   def download_random_images(self, count=100, width=128, height=128, path='./images/non_galaxies/'):
   ...
   def download_galaxy_images(self, count=100, page=1, path='./images/galaxies/'):
...
extractor.download_random_images(count=36)
